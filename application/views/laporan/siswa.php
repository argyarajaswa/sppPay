...
<body>
    <header class="p-0">
        ...
        <h2 class="ml-5 text-center">Pemerintah KeArgyaan Negara<br>Dinas Abal-Abal<br>Sekolah Menengah Kejuruan Negeri Mojoagung<br><span>Kelompok : Indonesia Emas<br>Program Keahlian : Teknik Komputer & Informatika dan Rekayasa Perangkat Lunak<br> Jl. Raya Veteran - Miagan - Mojoagung - Kabupaten Jombang Telp./Fax : (0336)  <br><span class="email"><b></b></span></span></h2>
    </header><br><br>
