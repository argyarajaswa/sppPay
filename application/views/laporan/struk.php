...
<head>
    ...
    <title>Struk Pembayaran SppPay</title>
...
<body>
    ...
    <header>
        <p>Sekolah Menengah Kejuruan Negeri Mojoagung<br><span>Jl. Raya Veteran No.66<br> Miagan - Mojoagung - Kabupaten Jombang <br> Telp./Fax : (0336) 123412</span></p>
    </header>
    <hr class="hr1">
    <hr class="hr2">
    ...
    <div id="content">
        ...
        <div class="ttd">
            <p>Kabupaten Jombang, <?= date('d-M-Y', strtotime($transaksi['TGL_BAYAR'])) ?><br><?= $transaksi['nama_petugas'] ?></p>
            <br>
            <br>
            <p class="garis"></p>
        </div>
