...
<body>
    ...
    <section class="main" id="main">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h2>sppPay Sekolah</h2>
                    <p class="lead">Platform ini dikembangkan sebagai bagian dari Uji Kompetensi Keahlian, dengan tujuan memudahkan proses pembayaran SPP secara efisien, aman, dan terstruktur. Jika kamu memiliki kritik, saran, atau masukan, jangan ragu untuk menghubungi kami melalui email : <a href="arrajzgay@gmail.com" class="email" target="_blank">arrajzgay@gmail.com</a></p>
                </div>
            ...
            <div class="row text-center">
                <div class="col-md">
                    <ul class="nav mb-3">
                        ...
                        <li class="nav-item"><a href="https://www.instagram.com/argyarf_/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                        <li class="nav-item"><a href=""><i class="fab fa-whatsapp"></i></a></li>
                    </ul>
                    <p class="lead">Copyright &copy; <?= date('Y') ?>, Design & Developer By Argya Rajaswa</p>
